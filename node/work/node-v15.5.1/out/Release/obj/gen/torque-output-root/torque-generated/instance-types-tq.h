  ...
  V(FIRST_HEAP_OBJECT_TYPE, 0) \
    ...
    V(FIRST_JS_RECEIVER_TYPE, 183) \
      ...
      V(FIRST_JS_OBJECT_TYPE, 184) \
        ...
        V(JS_FINALIZATION_REGISTRY_TYPE, 1069) \
        V(JS_LIST_FORMAT_TYPE, 1070) \
        V(JS_LOCALE_TYPE, 1071) \
        V(JS_MESSAGE_OBJECT_TYPE, 1072) \
        V(JS_NUMBER_FORMAT_TYPE, 1073) \
        V(JS_PLURAL_RULES_TYPE, 1074) \
        V(JS_PROMISE_TYPE, 1075) \
        V(JS_REG_EXP_TYPE, 1076) \
        V(JS_REG_EXP_STRING_ITERATOR_TYPE, 1077) \
        V(JS_RELATIVE_TIME_FORMAT_TYPE, 1078) \
        V(JS_SEGMENT_ITERATOR_TYPE, 1079) \
        V(JS_SEGMENTER_TYPE, 1080) \
        V(JS_SEGMENTS_TYPE, 1081) \
