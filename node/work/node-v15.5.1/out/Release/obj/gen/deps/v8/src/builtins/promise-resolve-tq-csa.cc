...
TF_BUILTIN(PromiseResolve, CodeStubAssembler) {
  ...
  if (block5.is_used()) {
    ...
    CodeStubAssembler(state_).StaticAssert(TNode<BoolT>{tmp12}, "static_assert(nativeContext == LoadNativeContext(context)) at ../../deps/v8/src/builtins/promise-resolve.tq:45:5");
...
TF_BUILTIN(ResolvePromise, CodeStubAssembler) {
  ...
  if (block31.is_used()) {
    ...
    CodeStubAssembler(state_).StaticAssert(TNode<BoolT>{tmp36}, "static_assert(nativeContext == LoadNativeContext(context)) at ../../deps/v8/src/builtins/promise-resolve.tq:155:7");
