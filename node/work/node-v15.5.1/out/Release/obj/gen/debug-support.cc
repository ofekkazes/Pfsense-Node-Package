...
int v8dbg_type_ExportedSubClass2__EXPORTED_SUB_CLASS2_TYPE = EXPORTED_SUB_CLASS2_TYPE;
...
int v8dbg_type_JSSegments__JS_SEGMENTS_TYPE = JS_SEGMENTS_TYPE;
...
int v8dbg_type_OnHeapBasicBlockProfilerData__ON_HEAP_BASIC_BLOCK_PROFILER_DATA_TYPE = ON_HEAP_BASIC_BLOCK_PROFILER_DATA_TYPE;
...
int v8dbg_type_SloppyArgumentsElements__SLOPPY_ARGUMENTS_ELEMENTS_TYPE = SLOPPY_ARGUMENTS_ELEMENTS_TYPE;
...
int v8dbg_type_WasmTypeInfo__WASM_TYPE_INFO_TYPE = WASM_TYPE_INFO_TYPE;
...
int v8dbg_class_Map__wasm_type_info__WasmTypeInfo = Map::kConstructorOrBackPointerOrNativeContextOffset;
